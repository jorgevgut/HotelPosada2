<html>
    ...
    error="[controller:'login']">Log out/salir</auth:logoutLink>
                ...
                <auth:ifLoggedIn>
                  <p>Usuario: <auth:user/></p>
                  <p><auth:logoutLink success="[controller:'login']"
                                      error="[controller:'login']"><input type="button" value="logout"/>
                  </auth:logoutLink></p>
                  <p><g:if test="${auth.user() ==hotelposada.Users.get(1).login}">

                    <g:link controller="admin">Panel de Administracion</g:link>
                                                          </g:if></p>
                </auth:ifLoggedIn>
            </div>
        </div>
